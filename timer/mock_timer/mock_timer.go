...
// Source: github.com/ankeesler/wildcat-countdown/timer (interfaces: Store)
...
func (m *MockStore) Get(arg0 string) (interface{}, error) {
...
func (m *MockStore) Set(arg0 string, arg1 interface{}) error {
